...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastName = array(
        ...
        'Dach', 'D\'Amore', 'Daniel', 'Dare', 'Daugherty', 'Davis', 'Deckow', 'Denesik', 'Dibbert', 'Dickens', 'Dickinson', 'Dickson', 'Dietrich', 'Donnelly', 'Dooley', 'Douglas', 'Doyle', 'Durgan',
        'Ebert', 'Edwards', 'Effertz', 'Eichmann', 'Emard', 'Emmerich', 'Erdman', 'Ernser', 'Fadel',
        ...
        'Schaden', 'Schaefer', 'Schamberger', 'Schiller', 'Schimmel', 'Schinner', 'Schmeler', 'Schmidt', 'Schmitt', 'Schneider', 'Schoen', 'Schowalter', 'Schroeder', 'Schulist', 'Schultz', 'Schumm', 'Schuppe', 'Schuster', 'Senger', 'Shanahan', 'Shields', 'Simonis', 'Sipes', 'Skiles', 'Smith', 'Smith', 'Smitham', 'Spencer', 'Spinka', 'Sporer', 'Stamm', 'Stanton', 'Stark', 'Stehr', 'Steuber', 'Stiedemann', 'Stokes', 'Stoltenberg', 'Stracke', 'Streich', 'Stroman', 'Strosin', 'Swaniawski', 'Swift',
        ...
        'Yost', 'Yundt',
        'Zamick', 'Zboncak', 'Zemlak', 'Ziemann', 'Zieme', 'Zulauf'
    );

    private static $suffix = array(
        // Diplomas and foundation courses
        'FdA',    // Arts
        'FdEng',  // Engineering
        'FdSc',   // Science
        'DipSW',
        ...
        'BAE',    // Arts & Economics
        'BArch',  // Architecture
        'BASc',   // Arts and Science
        'BAppSc', // Applied Science
        'BASS',   // Arts in the social sciences
        'BBA',    // Business Admin
        ...
        'BChD',   // Dental surgery
        'BEcon',  // Economics
        'BEcon&Fin', // Economics and Finance
        'BEd',    // Education
        'EdB',    // Education
        'B.Eng',   // Engineering
        'BE',     // Engineering
        ...
        'BPhil',  // Philosophy
        'B.Sc',    // Science
        'B.Sc(Psych)', // Science in psychology
        ...
        'BChir',  // Surgery
        'BCh',    // Surgery
        'BVetMed', // Vetinary Medicine
        'VetMB',  // Vetinary Medicine
        'BVMS',   // Vetinary Medicine & Surgery
        'BVM',    // Vetinary Medicine
        'BVMedSc', // Vetinary Medical Science
        'BVSc',   // Vetinary Science
